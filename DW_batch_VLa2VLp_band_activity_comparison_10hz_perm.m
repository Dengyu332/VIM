            ...
            for locking_id = 1:2
                ...
                switch locking_id
                    case 1 % spct
                        ...
                        [p1,~,~] = permTest(z_VLa_10hz',z_VLp_10hz',10000,'sidedness','larger');
                        [p2,~,~] = permTest(z_VLa_10hz',z_VLp_10hz',10000,'sidedness','smaller');
                        ...
                        ap = find(p1<0.05); % VLa > VLp

                        pa = find(p2<0.05); % VLa < VLp
                        ...
                        saveas(gcf,[dionysis 'Users/dwang/VIM/Results/New/v2/band_region_comparison_10hz_perm/'...
