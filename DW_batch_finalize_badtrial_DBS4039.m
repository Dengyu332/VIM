...
% deal with DBS4039 specifically
% loop through *_session*_subcort_trials_step1.mat, quantitatively find
%bad trials, and find incomplete trials
%merge 3 kind of bad trials together to get the final bad trials for a session
%generate *_session*_subcort_trials_step2.mat

DW_machine;
data_dir = dir([dionysis 'Users/dwang/VIM/datafiles/preprocessed_new/v2/subcort/DBS4039*_step1.mat']);
fs = 1000;
...
%     quanbad_idx = candidates(candi_indx);% quantitatively defined bad trials
    ...
    D.state = 'notch_filt,ds to 1khz,lpf_400, hpf_2, badch detected,badtrial of all type identified, trials defined as -2 to +3 peri-cue';
    
    save([dionysis 'Users/dwang/VIM/datafiles/preprocessed_new/v2/subcort/' data_dir(total_session_idx).name(1:end-10) '_step2.mat'],'D','session_epoch','-v7.3'); % save locally
end