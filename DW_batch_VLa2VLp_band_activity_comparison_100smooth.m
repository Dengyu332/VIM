...
% generate figures of VLa vs. VLp of different bands under band_region_comparison_100smooth folder
            ...
            for locking_id = 1:2
                ...
                switch locking_id
                    case 1 % spct
                        ...
                        t = linspace(-2,2,4001);
                        figure;
                        plot(t,smooth(z_VLa_avg,100),'LineWidth',3); hold on;plot(t,smooth(z_VLp_avg,100),'LineWidth',3);
                        ...
                        saveas(gcf,[dionysis 'Users/dwang/VIM/Results/New/v2/band_region_comparison_100smooth/'...
